...
image: /og/2024-12-25-inertia-v2.jpg
pubDate: 2024-12-25
category: coding
...
這個 Cache 的機制，要找一個接近的技術的話，應該是借鑑了 HTTP Cache-Control 的 stale-while-revalidate 機制吧？這是我後來才知道的XD
...
Infinite Scroll 在 Inertia v2.2 終於推出了~

參考文章：[Inertia v2.2 的 Infinite Scroll (無限滾動) 新功能](/posts/inertia-v2-infinite-scroll)
