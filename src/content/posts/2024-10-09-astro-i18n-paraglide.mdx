...
description: 在 Astro 中搭配 Paraglide 實作多語系功能
...
<Warning>
這篇文章是我在研究 Astro i18n 寫的筆記，但內容不建議使用，現在在 Astro 做多語系請參考 [Astro + @astrolicious/i18n 實作 i18n 多語系功能](/posts/astro-i18n-astrolicious) 來使用。
</Warning>
